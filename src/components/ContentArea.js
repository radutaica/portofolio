  ...
  const getContentLines = () => {
    switch (activeTab) {
      case '/about/education/bachelor':
        return ['Bachelors','Bachelor of Science with Honours in Computer Science,', 'Grade: Class I','City University of London', 'September 2019 - June 2022', '', 'Modules: Introduction to Algorithms, Mathematics for', 'Computing, Systems Architecture, Programming in Java,', 'Databases, Operating Systems, Data Structures and', 'Algorithms, Language Processors, Computer Networks', 'Object-Oriented Analysis and Design, Programming in C++', 'Advanced Programming: Concurrency, Functional Programming,', 'Games Technology'  ];
      case '/about/work/job1':
        return ['TakeOff Labs', 'Full Stack Developer', 'November 2022 - Present', '', 'Tech Stack: Ruby on Rails, Node.js, React.js, React-Native,', 'AWS, Stripe, Git, PostgreSQL, Redis, SideKiq, CLI, EAS, Expo'];
      default:
